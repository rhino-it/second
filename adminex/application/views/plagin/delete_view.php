...
<div class="wrapper">
    <div class="row">
        ...
        <form action="<?php echo base_url('adminex/plagin/delete_statement');  ?>" method="POST">		
            <div class="col-sm-12">
                <section class="panel panel-danger">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group input-group-lg m-bot15">
                                        <span class="input-group-addon">
                                            ...
                                            $_SESSION['right_answer'] = $_SESSION['ex_check_a']+$_SESSION['ex_check_b'];
                                             echo $_SESSION['ex_check_a'] . ' + ' . $_SESSION['ex_check_b'] . ' ='; ?> 
                                        </span>
                                        <input type="text" name="answer" class="form-control input-lg" placeholder="?">
                    ...
                    <div class="panel-footer">
                        ...
                        <button class="btn btn-default" onclick="" ><i class="fa fa-reply"></i> Отмена</button>
                    </div>
                </section>
            </div>			
        </form>    
