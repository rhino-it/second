				...
				<form enctype="multipart/form-data" action="<?php echo base_url('adminex/plagin/add_to_base') ?>"  class="form-horizontal" method="POST">
					<div class="panel-body">
						<div class="form">
							...
							<div class="form-group">
							<input type="text" name="year" class="form-control" id="userIdType"  list = "id_year" value="<?php echo $edit['year']; ?>"> 
							<input type="hidden" name="file_name" value="<?php echo $edit['file']; ?>">
	  ...
	  <?php 
		...
		<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="form-group">
										<input type="text" name="edition" class="form-control" id="userIdType"  list = "id_edition" value="<?php echo $edit['edition']; ?>"> 
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="form-group">
										<input type="text" class="form-control" id="userIdType" name="science"   list = "id_science" value="<?php echo $edit['science']; ?>"> 
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="form-group">
										<input type="text" class="form-control" id="userIdType" name="author"   list = "id_author" value="<?php echo $edit['author']; ?>"> 
										...
										<div class="tab-pane active" id="ru">
											<div class="form-group">
												<div class="col-sm-12">
													...
													<input name="tema_ru" class="form-control" id="focusedInput" type="text" placeholder="Заголовок" value="<?php echo $edit['tema_ru']; ?>">
											...
											<div class="form-group">
												<div class="col-sm-12">
													...
													<textarea class="form-control" name="text_ru" rows="6"><?php echo $edit['text_ru']; ?></textarea>
												</div>
											</div>
										...
										<div class="tab-pane" id="kg">
											<div class="form-group">
												<div class="col-sm-12">
													...
													<input name="tema_kg" class="form-control" id="focusedInput" type="text" placeholder="Башкы" value="<?php echo $edit['tema_kg']; ?>">
											...
											<div class="form-group">
												<div class="col-sm-12">
													...
													<textarea class="form-control" name="text_kg" rows="6"><?php echo $edit['text_kg']; ?></textarea>
												</div>
											</div>
										...
										<div class="tab-pane" id="en">
											<div class="form-group">
												<div class="col-sm-12">
													...
													<input name="tema_en" class="form-control" id="focusedInput" type="text" placeholder="Headline" value="<?php echo $edit['tema_en']; ?>">
											...
											<div class="form-group">
												<div class="col-sm-12">
													...
													<textarea class="form-control" name="text_en" rows="6"><?php echo $edit['text_en']; ?></textarea>
												</div>
											</div>
			...
			<div class="panel-footer">
				<button class="btn btn-success" name="submit_edit_base" type="submit"><i class="fa fa-save"></i> Сохранить</button>
			</div>
		</form>
	</section>
